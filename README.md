...
orbit camera pivot on that gear's sphere centre; closing it returns the
pivot to the root. double-click empty space (or `f`) reframes; the menu also
has a "view" quick row.
### state
